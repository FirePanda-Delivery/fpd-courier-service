package ru.diplom.fpd.courier.configuration.security;
...
import ru.diplom.fpd.courier.dto.AuthenticatedUser;
...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private AuthenticatedUser getUser(Jwt jwt) {
        return AuthenticatedUser.builder()
                .id(jwt.getClaim("sub"))
                .email(jwt.getClaim("email"))
                .firstName(jwt.getClaim("given_name"))
                .lastName(jwt.getClaim("family_name"))
                .phone(jwt.getClaim("phode"))
                .build();
//        return userApi.getUser(jwt.getClaim("preferred_username")).getBody();
    }
